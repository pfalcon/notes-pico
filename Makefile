...
lib: requirements.txt
	pycopy -m upip install -p lib -r requirements.txt

run:
	MICROPYPATH=lib pycopy -X heapsize=150wK -m notes_pico
...
run-mpy:
	cd mpy; MICROPYPATH=lib pycopy -X heapsize=50wK -m notes_pico
